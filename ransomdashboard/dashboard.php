...
$stmt = $pdo->query("SELECT key_id, machine_id, encryption_key, receive_date, status, stop_signal FROM machine_keys ORDER BY receive_date DESC");
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 text-white">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($key['receive_date']); ?></td>
